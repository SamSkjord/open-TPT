...
> NOTE: This working copy now lives in `WAVESHARE_DUAL_CAN_HAT_SETUP.md` at the repo root. Please edit that canonical file; this version is retained for reference only.
...
**File: `/etc/udev/rules.d/80-can-persistent-names.rules`**
...
**Installation:**
```bash
sudo cp 80-can-persistent-names.rules /etc/udev/rules.d/
