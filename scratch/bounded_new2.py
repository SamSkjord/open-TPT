...
def draw_enhanced_visualization(
    ...
    if debug_mode:
        ...
        pygame.draw.line(screen, (255, 255, 0), (region_left, y_offset), (region_left, y_offset + box_height), 2)
        pygame.draw.line(screen, (255, 255, 0), (region_right, y_offset), (region_right, y_offset + box_height), 2)
