...
class FuelDisplay:
    ...
    def draw(self, screen):
        ...
        # Draw consumption info
        self._draw_consumption(screen, state)

        # Draw estimates
        self._draw_estimates(screen, state)
    ...
    def _draw_consumption(self, screen, state):
        """Draw fuel consumption information."""
    ...
    def _draw_estimates(self, screen, state):
        """Draw remaining fuel estimates."""
